...
import spacy
from utils import compile_defs as cdefs
import time
import re
import ast
import logging
...
#     try:
    ...
    print("document_set_json",document)
    ...
    if dom_model_enabled :
        ...
        print("num_pagesx",num_pages)
        content=parse_document(document.get("documentPages"))
        print("\n content_set_json_start",content)
        print("/n content_set_json_end")
