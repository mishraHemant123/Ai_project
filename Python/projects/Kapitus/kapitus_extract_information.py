...
import spacy
# from extractors import compile_defs as cdefs
import time
import re
import ast
...
from extractors import document_extractor as doc_ext
...
#     model=Extractor(country_code, data_dir, model_dir, model_name, logs_dir, dom_model_enabled, dom_model_name)
    for file in files:
        ...
        if name=="Zero_Balance_Letter_6415011":
            defs=['extractors/definition_Zero_Balance_Letter_6415011.json']
        elif name=="Payoff_Letter_OnDeck_6343191":
            defs=['extractors/definition_Payoff_Letter_OnDeck_6343191.json']
        elif name=="Application_Fundera_6455061_x":
            defs=['extractors/definition_Application_Fundera_6455061_x.json']
        elif name=="Application_Fundera_6455061":
            defs=['extractors/definition_Application_Fundera_6455061.json']
